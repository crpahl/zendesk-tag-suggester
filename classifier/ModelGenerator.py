...
mult_nb = Pipeline([("count_vectorizer", CountVectorizer(analyzer=lambda x: x)), ("multinomial nb", model_nb)])
...
mult_nb.fit(X, y)
pickle.dump( model_nb, open( "model.p", "wb" ) )

print mult_nb.predict(X[0])
